...
public class FrontControllerServlet extends HttpServlet {
    ...
    private void injectComponent(){
        controllersMapping.values().stream().forEach(controller ->
                Arrays.stream(controller.getClass().getDeclaredFields())
                        ...
                        .forEach(field -> {
                            ...
                            String annotation = field.getAnnotation(Resource.class).name();
                            Object component = ComponentContext.getInstance().getComponent(annotation);
                            try {
